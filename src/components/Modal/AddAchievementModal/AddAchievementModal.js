...
import { addNewAchievement } from "../../../actions/InstituteAction";
...
const AddAchievementModal = ({ setAddAchievement }) => {
  ...
  const handleOnSubmit = () => {
    ...
    achievement.push(newFaculty);
    dispatch(addNewAchievement(achievement));
            ...
            <div className="relative px-6 h-[50vh] overflow-y-auto scrollbar-hide flex-auto">
              <div className="flex flex-col">
                ...
                <input
                  ...
                  className="py-2 px-3 my-2 rounded-lg border-[#000]"
                  type="text"
                  placeholder="Title"
                />
                <textarea

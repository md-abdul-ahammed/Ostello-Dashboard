...
const AllStudents = () => {
  ...
  return (
    <div className="bg-white md:mb-12 my-6 shadow-lg md:shadow-none md:mx-8 mx-3 rounded-lg md:border border-0 py-5">
      ...
      <div className="bg-white md:mt-5 mt-0 p-3 rounded-lg">
        <table className="md:block hidden">
          <thead className="bg-white table w-full table-fixed border-b">
            <tr>
              <th
                scope="col"
          ...
          <tbody className="">
            {allData.map((data, index) => (
              <tr
                ...
                key={index}
                className="bg-white border-b cursor-pointer transition duration-300 ease-in-out hover:bg-gray-100 table w-full table-fixed"
              >
